        ...
        if(UserService.checkUserName(username)){
            ...
            Thread mailThread = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    sb.append("<button style=\"padding:20px 15px;color:#fff;font-size:16px;background-color:#343a40;border-radius:4px\"><a style=\"color:#fff;text-decoration: none;\" href=http://localhost:8080/").append("/verified?id=" + user.getId() + "&"+ "randomData="+ randomData + ">").append("Xác thực email</a></button>").append("<br><br>");
