          ...
          /*  if(UserService.checkToken(token)){
            ...
            Thread mailThread = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    sb.append("<button style=\"padding:20px 15px;color:#fff;background-color:#343a40;border-radius:4px;\"><a href=http://localhost:8080/").append("/change-password?token=").append(token).append(" style=\"font-size:16px;text-decoration: none;color:#fff\">Thiết lập lại mật khẩu</a></button>").append("<br><br>");
