...
@WebServlet(name = "RevenueStatisticsByCategory", value = "/admin-revenue-by-category")
public class RevenueStatisticsByCategory extends HttpServlet {

    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        LocalDate currentDate = LocalDate.now();
        Map<String, Double> result = StatisticsService.statisticsByCategory(currentDate.getMonthValue(), currentDate.getYear());
        ...
        request.getRequestDispatcher("views/admin/pie-chart.jsp").forward(request,response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Xử lý dữ liệu
        Map<String, Double> result = StatisticsService.statisticsByCategory(month, year);
