...
public class RegisterTransport {
    public static Transport registerTransport(String token, String from_district_id, String from_ward_id, String to_district_id, String to_ward_id) throws IOException {
        String height = "100";
        String length = "100";
        String width = "100";
        String weight = "100";
        ...
        Transport transport = new Transport(id, convertCreatedAt(createdAt), convertLeadTime(leadTime));
        return transport;
    ...
    public static void main(String[] args) throws IOException, JSONException, ParseException {
        ...
        try {
            ...
            Transport transport = registerTransport(token, from_district_id, from_ward_id, to_district_id, to_ward_id);
