                                        ...
                                        <div class="block-content">
                                            <c:forEach var="pty" items="${listType}">
                                                <div class="cateTitle hasSubCategory open level1">
                                                    <a class="cateItem" href="productCate?cid=${pty.type_id}">${pty.type_name}</a>
                                                </div>
                                            </c:forEach>
                                        </div>
                                    </div>
                                        ...
                                        <div class="product-single row">
                                                    ...
                                                    <div class="images-container">
                                                        <div class="js-qv-mask mask tab-content border">
                                                            <div id="item1" class="tab-pane fade active in show">
                                                                <img src="${pro.getImage(0)}" alt="img">
                                                            </div>
                                                            <div id="item2" class="tab-pane fade">
                                                                <img src="${pro.getImage(1)}" alt="img">
                                                            </div>
                                                            <div id="item3" class="tab-pane fade">
                                                                <img src="${pro.getImage(2)}" alt="img">
                                                            </div>
                                                            <div id="item4" class="tab-pane fade">
                                                                <img src="${pro.getImage(3)}" alt="img">
                                                            </div>
                                            ...
                                            <div class="product-info col-xs-12 col-md-7 col-sm-7">
                                                <div class="detail-description">
                                                    <div class="price-del">
                                                        <span class="price">${pro.formatCurrency(pro.price_sell)}</span>
                                                        <span class="float-right">
                                                            ...
                                                            ${pro.statusProduct(pro.status)}
                                                        </span>
                                                    </div>
                                                    <div class="option size-color">
                                                        <div class="size" style="font-size: 15px;font-weight: bold;">
                                                            <del>${pro.formatCurrency(pro.price)}</del>
                                                        </div>
                                                        <div class="colors">
                                                            <div class="title">Màu : ${pro.color}</div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="product-quantity">
                                                            <div class="qty">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="hidden" id="productStatus" value="${pro.status}">
                                                                    <span class="add">
                                                                        <a class="addToWishlist" href="#" id="addToCartLink" data-product-id="${pro.product_id}">
                                                                            <i class="fa fa-shopping-cart" aria-hidden="true"></i>
                                                                        </a>
                                                                        <a class="addToWishlist" href="#" id="addToFavLink" data-product-id="${pro.product_id}">
                                        ...
                                        <div class="review">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div id="tag" class="tab-pane fade">
                                                    <div class="spr-form">
                                                        <div class="fb-comments" data-href="https://datthanhnguyen1920.000webhostapp.com/${pro.product_id}" data-width="" data-numposts="10"></div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <c:forEach var="review" items="${reviews}">
                                                                <div class="spr-review">
                                                                    ...
                                                                    <div class="spr-review-content">
                                                                        <p class="spr-review-content-body">${review.reviewText}</p>
                                                                    </div>
                                                                </div>
                                                            </c:forEach>
                                                        </div>
                                                    </div>
                                                    <form method="post" action="addReview" class="new-review-form">
                                                        ...
                                                        <fieldset>
                                                            <div class="spr-form-review-body">
                                                                <div class="spr-form-input">
                                                                    <textarea class="spr-form-input-textarea" name="review_text" rows="5" placeholder="Hãy chia sẻ nhận xét cho sản phẩm này bạn nhé !!!"></textarea>
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                        <%
...
<%--                                                        </div>--%>
                                        ...
                                        <div class="related">
                                            ...
                                            <div class="tab-content">
                                                <div class="row">
                                                    <c:forEach var="psm" items="${sameProduct}">
